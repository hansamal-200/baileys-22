...
export const PROTOCOL_ADAPTERS = {
    'redis:': '@keyv/redis', 'rediss:': '@keyv/redis',
    'mongodb:': '@keyv/mongo', 'mongodb+srv:': '@keyv/mongo',
    'postgres:': '@keyv/postgres', 'postgresql:': '@keyv/postgres',
    'mysql:': '@keyv/mysql',
    'sqlite:': '@keyv/sqlite',
    'memcache:': '@keyv/memcache', 'memcached:': '@keyv/memcache',
    'etcd:': '@keyv/etcd',
}
