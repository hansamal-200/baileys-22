...
export const makeMessagesRecvSocket = (config) => {
  ...
  const placeholderResendCache = config.placeholderResendCache || sockPlaceholderResendCache || new NodeCache({ stdTTL: DEFAULT_CACHE_TTLS.MSG_RETRY, useClones: false })
